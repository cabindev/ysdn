    ...
    <div class="row mt-5">
        <div class="col">
            <div class="card m-3">
                ...
                <div class="container">
                    <form class="row g-3" action="save-form-Admin.php" method="POST" id="myForm" enctype="multipart/form-data">
                    <?= csrf_field() ?>
    ...
    <script type="text/javascript">
        ...
        function validateFileSize(input) {
            ...
            if (file.size > maxSize) {
                alert('ขนาดของไฟล์ใหญ่เกิน 5 MB กรุณาแก้ไขขนาดไฟล์ก่อนอัปโหลดอีกครั้ง.');
