...
<div class="wrapper">
              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  <tbody>
                    <?php
                    $userObj = new User();
                    $userDatas = $userObj->getAllUser($userData);
                    $n=0;
                    foreach($userDatas as $userData) {
                      $n++;
                    echo "
                      <tr>
                        <td><img src='{$userData['avatar']}' alt='Avatar' width='50'></td>
                        <td>{$userData['email']}</td>
                        <td>{$userData['firstname']}</td>
                        <td>{$userData['lastname']}</td>
                        <td>{$userData['nickname']}</td>
                        <td>{$userData['citizen_id']}</td>
                        <td>{$userData['member_code']}</td>
                        <td>{$userData['dob']}</td>
                        <td>{$userData['gender_id']}</td>
                        <td>{$userData['phone']}</td>
                        <td>{$userData['address']}</td>
                        <td>{$userData['district']}</td>
                        <td>{$userData['amphoe']}</td>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="https://adminlte.io">YSDN</a>.</strong> All rights reserved.
  </footer>
